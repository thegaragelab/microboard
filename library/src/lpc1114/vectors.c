/*--------------------------------------------------------------------------*
* Interrupt vector table for LPC1114
*---------------------------------------------------------------------------*
* 22-Jan-2014 ShaneG
*
* Merged from various sources on the internet.
*--------------------------------------------------------------------------*/

/** Implement the default interrupt handler.
 *
 * When a user implemented handler is not available this implementation will
 * be called instead. It simply causes the device to lock up in an endless
 * loop.
 */
